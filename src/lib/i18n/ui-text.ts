...
export const UI_TEXT = {
  zh: {
    ...
    meetingBoard: {
      ...
      transcriptTitle: "原始发言记录",
      speech: "发言",
      modelLabel: "模型：",
      recapTitle: "会议复盘总览",
      recapDescription: "按阶段回看本轮圆桌如何推进，快速定位观点、回应和总结。",
      recapSummaryStageTitle: "共识整理",
      recapSummaryDescription: "系统整理讨论共识、分歧和下一步。",
      recapTurnUnit: "条发言",
      recapParticipants: "参与模型：",
      recapExcerpt: "摘录：",
      recapEmptyStage: "该阶段没有可展示的发言。",
      modelComparisonTitle: "模型对照",
      modelComparisonDescription: "横向比较每个模型的独立观点、自由回应和缺席/失败情况。",
      independentViewLabel: "独立观点",
      responseViewLabel: "自由回应",
      noResponseLabel: "未参与回应",
      failedResponseLabel: "回应失败",
      emptyExcerpt: "暂无可展示内容。",
      evidenceGuardTitle: "证据限制护栏",
      evidenceGuardDescription:
        "本轮存在低证据或引用限制，复盘中的结论应优先按推理观点阅读，涉及实时事实仍需人工核验。",
  ...
  en: {
    ...
    meetingBoard: {
      ...
      transcriptTitle: "Original Transcript",
      speech: "Turn",
      modelLabel: "Model: ",
      recapTitle: "Meeting Recap",
      recapDescription:
        "Review how this roundtable progressed across views, responses, and summary.",
      recapSummaryStageTitle: "Summary",
      recapSummaryDescription:
        "The system organized discussion consensus, differences, and next steps.",
      recapTurnUnit: "turn(s)",
      recapParticipants: "Participants: ",
      recapExcerpt: "Excerpt: ",
      recapEmptyStage: "No turns were available for this stage.",
      modelComparisonTitle: "Model Comparison",
      modelComparisonDescription:
        "Compare each model's independent view, response, and missing or failed participation.",
      independentViewLabel: "Independent View",
      responseViewLabel: "Response",
      noResponseLabel: "No response turn",
      failedResponseLabel: "Response failed",
      emptyExcerpt: "No content available.",
      evidenceGuardTitle: "Evidence Guardrail",
      evidenceGuardDescription:
        "This meeting has low-evidence or citation limits. Treat conclusions as reasoning first, and manually verify real-time factual claims.",
