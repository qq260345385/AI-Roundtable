...
function SettingsDropdown({
  ...
  return (
    <details className="group relative">
      <summary
        className="control-button focus-ring ml-auto flex w-fit list-none items-center gap-1.5 border border-zinc-200 bg-white/80 px-3 py-1.5 text-sm font-medium text-zinc-700 shadow-sm hover:cursor-pointer hover:border-emerald-200 hover:bg-white hover:text-zinc-950 hover:shadow-md active:scale-95 [&::-webkit-details-marker]:hidden"
      >
        ...
        {text.settings.title}
          ...
          <div className="surface-panel absolute right-0 z-50 mt-2 w-[min(18rem,calc(100vw-2.5rem))] p-4">
            <div className="space-y-4">
              <div>
                ...
                <div className="flex gap-1">
                  <button
                    className={`control-button flex-1 px-3 py-1.5 text-xs font-medium ${
                      locale === "zh"
                        ? "bg-emerald-700 text-white"
                        : "bg-zinc-100 text-zinc-600 hover:bg-white"
                    }`}
              ...
              <div>
                ...
                <select
                  className="focus-ring w-full rounded-lg border border-zinc-300 bg-white px-2.5 py-1.5 text-[11px] text-zinc-800"
